...
void loop() {
  colorChase(strip.Color(127,127,127), 30);

  // Send a simple pixel chase in...
  colorChase(strip.Color(127,0,0), 30);  	// full brightness red
  colorChase(strip.Color(127,127,0), 30);	// orange
  colorChase(strip.Color(0,127,0), 30);		// green
  colorChase(strip.Color(0,127,127), 30);	// teal
  colorChase(strip.Color(0,0,127), 30);		// blue
  colorChase(strip.Color(127,0,127), 30);	// violet
